...
export function GoogleSignInButton({
  ...
  return (
    <button
      ...
      onClick={handleClick}
      disabled={disabled}
      className="flex w-full items-center justify-center gap-2 rounded-xl border border-[var(--border-subtle)] bg-bg-base px-4 py-2.5 font-medium text-text-primary shadow-[var(--shadow-soft)] transition-colors duration-200 hover:opacity-90 disabled:opacity-50"
    >
